...
Because, *"It is worse to class a customer as good when they are bad (5), than it is to class a customer as bad when they are good (1)."* ([see](https://archive.ics.uci.edu/ml/datasets/Statlog+(German+Credit+Data))), precision is a useful metric. It measures the proportion of True Positives (`r conf_matrix$table[2,2]` labelled good loans that were actually good), out of the True Positives plus False Positives (`r conf_matrix$table[2,1]` labelled good loans that were actually bad). This is the bottom row of the confusion matrix: `r conf_matrix$table[2,2]` / (`r conf_matrix$table[2,1]` + `r conf_matrix$table[2,2]`) = `r round(conf_matrix$table[2,2]/(conf_matrix$table[2,1]+conf_matrix$table[2,2]),3)`.
